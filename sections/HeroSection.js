      ...
      <div className="absolute inset-0 flex">
        {STRIPS.map((strip, i) => (
          <div key={i} className="relative flex-1 overflow-hidden">
            <div
              className="strip hero-bg absolute top-0 h-full"
              style={{ width: "100vw", left: strip.offset, animationDelay: strip.delay }}
            />
          </div>
        ))}
      </div>
        ...
        <div className="grid w-full grid-cols-1 items-center gap-16 lg:grid-cols-2">
          ...
          <div className="flex flex-col gap-7">
            ...
            <h1
              className="animate-textUp text-4xl text-white font-black leading-tight tracking-tight sm:text-5xl xl:text-6xl"
            ...
            <p
              className="animate-textUp max-w-lg text-base leading-relaxed text-white/55"
            ...
            <div
              className="animate-textUp flex flex-wrap gap-4"
              style={{ animationDelay: "1.6s" }}
            >
              <Link
                href="/courses"
                className="group inline-flex items-center gap-2 rounded-lg bg-purple-700 px-7 py-3.5 text-sm font-semibold text-white shadow-lg shadow-purple-900/40 transition hover:bg-purple-600"
              >
                Explore Courses
            ...
            <div
              className="animate-fadeIn flex items-center gap-8 border-t border-white/10 pt-6"
