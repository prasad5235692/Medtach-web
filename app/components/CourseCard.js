...
export default function CourseCard({ course, locale = "en" }) {
  ...
  return (
    <div className="group flex h-full min-h-[24rem] flex-col overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1.5 hover:shadow-lg">
      ...
      <div className="flex flex-1 flex-col gap-3 p-6">
        ...
        <div className="mt-auto flex flex-wrap gap-3 border-t border-gray-100 pt-4 text-xs text-gray-400">
